...
pub fn build(b: *std.Build) !void {
    ...
    nng.addCSourceFiles(.{
        ...
        .flags = &.{"-DNNG_PLATFORM_POSIX","-DNNG_TRANSPORT_IPC"},
        .files = &.{
            "nng.c",
            "core/aio.c",
            "core/device.c",
    ...
    // Tests
    const tests = b.addTest(.{ .root_source_file = b.path("src/lib_test.zig") });
    tests.root_module.addImport("nng", nng);
    ...
    const example = b.addExecutable(.{
        .name = "zig-nng-example",
        .root_source_file = b.path("./main.zig"),
        .target = target,
        .optimize = optimize,
    });

    example.root_module.addImport("nng", nng);
    const example_artifact = b.addRunArtifact(example);

    const run_example = b.step("run", "Run the control panel");
    run_example.dependOn(&example_artifact.step);
}
